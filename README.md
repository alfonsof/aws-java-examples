...
* Lambda function handler:
  ...
  * [awslambdahttprequest](/awslambdahttprequest) - AWS Lambda Function Http Request: Example of how to handle an AWS Lambda Function, show the parameters of the request and respond a message including the parameters.
...
* Lambda service client - Service operations:
  ...
  * [awslambdaupdate](/awslambdaupdate) - AWS Lambda Function Update: Example of how to handle an AWS Lambda function and update it.
