...
public class S3Download {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String downloadFileName;   // Upload local file name

        if (args.length < 3) {
            System.out.println("Not enough parameters. Proper Usage is: java -jar s3download.jar <BUCKET_NAME> <OBJECT_NAME> <LOCAL_FILE_NAME>");
            System.exit(1);
        }
        ...
        try {
            ...
            FileOutputStream fileOutputStream = new FileOutputStream(new File(downloadFileName));
